...
export default function Cart() {
  ...
  async function fetchCartItems() {
    try {
      const res = await axios.get("https://ecommerce-qwuc.onrender.com/api/cart", {
        params: { userId },
      });
  ...
  async function removeItem(productId) {
    try {
      const res = await axios.post(
        "https://ecommerce-qwuc.onrender.com/api/cart/remove",
        { productId },
        { params: { userId } }
      );
      setCartItems(res.data.items);
  ...
  async function updateQuantity(productId, increment) {
    try {
      const res = await axios.post(
        "https://ecommerce-qwuc.onrender.com/api/cart/update-quantity",
        { productId, increment },
        { params: { userId } }
      );
      setCartItems(res.data.items);
